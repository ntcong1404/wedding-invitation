...
function App() {
  ...
  const handleSubmit = (e) => {
    ...
    if (nameGuest === "") {
      ...
      fetch(
        "https://script.google.com/macros/s/AKfycby0dx591X0EUf-urNnFqi8yPJ84cTOcLHJ9kK4gJ77AWp6jUhuYElWsVaKdoLx5BGPO/exec",
        {
          method: "POST",
          body: data,
        }
        ...
        <div>
          ...
          <div className="my-6 px-6">
            ...
            <form
              ...
              method="POST"
              action="https://script.google.com/macros/s/AKfycby0dx591X0EUf-urNnFqi8yPJ84cTOcLHJ9kK4gJ77AWp6jUhuYElWsVaKdoLx5BGPO/exec"
            >
              {/* guest */}
              <div className="grid grid-cols-2 gap-4 py-10 ">
                ...
                <input
                  ...
                  name="guest"
                  className=" text-blue-600 hidden bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                />
              </div>
              {/* guest name */}
              <div className="text-center">
                ...
                <input
                  onChange={(e) => setNameGuest(e.target.value.trim())}
              ...
              <div className="text-center mt-4">
                <h3 className="py-2 text-lg">Gửi lời nhắn hoặc lời chúc</h3>
                <textarea
                    ...
                    <>
                      ...
                      <div className=" p-4 rounded bg-[#f4f4f4] my-10">
                        <div className="text-sm">
                          <span>
                            Để thuận tiện cho việc sắp xếp, đưa đón khách đi
                            tiệc cưới, bạn vui lòng cung cấp số điện thoại giúp
                            vợ chồng mình nhé!
                          </span>
                        </div>
                      </div>
                      <div className=" p-4 rounded bg-[#f4f4f4] my-10">
                        <div className="text-sm">
                          ...
                          <br />
                          <span>
                            <strong>Người liên hệ: </strong>0362610156 - Thanh
                            Hương
                          </span>
                        </div>
                      </div>
              ...
              <div className="pt-6 grid grid-cols-1">
                <button
                  type="submit"
                  className="bg-[#6E8058] flex items-center justify-center text-white py-3 rounded-md text-xl hover:bg-[#73865c]"
                >
                  <p className="px-4">Gửi Phản Hồi</p>
                  {loading ? (
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      height="1em"
